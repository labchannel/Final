...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        Serial No.</HeaderTemplate>
                    ...
                    <FooterTemplate>
                       <asp:Button ID="btnAdd" runat="server" Text="Add new Employee" CommandName="AddNew" Width="152px" Height="30px" ToolTip="Add new User" meta:resourcekey="btnAddResource1" />
                    </FooterTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="EName" meta:resourcekey="TemplateFieldResource2">
                    <EditItemTemplate>
                        <asp:TextBox ID="TxtEName" runat="server" Text='<%# Eval("EName") %>' meta:resourcekey="TxtENameResource1" ></asp:TextBox>
                    </EditItemTemplate>
                    <FooterTemplate>
                        <asp:TextBox ID="TxtFEName" runat="server" meta:resourcekey="TxtFENameResource1"></asp:TextBox>
                        <br />
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="TxtFEName"  ErrorMessage="*Please Enter Name" Font-Bold="True" ForeColor="#CC3300" meta:resourcekey="RequiredFieldValidator2Resource1"></asp:RequiredFieldValidator>
                    </FooterTemplate>
                    <ItemTemplate>
                ...
                <asp:TemplateField HeaderText="EAddress" meta:resourcekey="TemplateFieldResource3">
                    <EditItemTemplate>
                        <asp:TextBox ID="txteaddr" runat="server" Text='<%# Eval("EAddress") %>' meta:resourcekey="txteaddrResource1" ></asp:TextBox>
                    </EditItemTemplate>
                    <FooterTemplate>
                        <asp:TextBox ID="TxtFAddress" runat="server" meta:resourcekey="TxtFAddressResource1"></asp:TextBox>
                        <br />
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="TxtFAddress" ErrorMessage="*Please Enter Address" Font-Bold="True" ForeColor="#CC3300" meta:resourcekey="RequiredFieldValidator3Resource1"></asp:RequiredFieldValidator>
                    </FooterTemplate>
                    <ItemTemplate>
                ...
                <asp:TemplateField HeaderText="EEmail" meta:resourcekey="TemplateFieldResource4">
                    <EditItemTemplate>
                        <asp:TextBox ID="TextBox1" runat="server" Text='<%# Eval("EEmail") %>' meta:resourcekey="TextBox1Resource1"></asp:TextBox>
                    </EditItemTemplate>
                    <FooterTemplate>
                        
                        <asp:TextBox ID="Txtemail" runat="server" ValidateRequestMode="Enabled" meta:resourcekey="TxtemailResource1"></asp:TextBox>
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Email is required" ForeColor="Red" ControlToValidate="Txtemail" meta:resourcekey="RequiredFieldValidator1Resource1"></asp:RequiredFieldValidator>                    
